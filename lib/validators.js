...
var validators = {
    ...
    isGreaterThan: function( value, options ){
        return value > options;
    },
    isLessThan: function( value, options ){
        return value < options;
    },
    isGreaterThanOrEqual: function( value, options ){
        return value >= options;
    },
    isLessThanOrEqual: function( value, options ){
        return value <= options;
    },
